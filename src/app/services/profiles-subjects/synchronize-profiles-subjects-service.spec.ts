...
describe('[Unit] Synchronize Profiles Subjects Service', () => {
	it('should return ProfileDoesNotExistsError if at least one profile has not been founded', async () => {
	...
	// it('should return ProfileDoesNotExistsError if at least one subject has not been founded', async () => {
